    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex-grow bg-green-100 py-16">
            <div class="container mx-auto text-center">
                ...
                <div class="mb-8">
                    <img src="{{ asset('images/site/hero-image.png') }}" alt="Vakantiehuis illustratie" <img
                        src="{{ asset('images/site/hero-image.png') }}" alt="Vakantiehuis illustratie"
                    ...
                    <form action="{{ route('huizen.index') }}" method="GET"
                        ...
                        <p class="mt-2 text-sm text-gray-500">Laatste zoekopdracht:
                            <a href="{{ session('last_search') ? route('huizen.index', ['query' => session('last_search')]) : '#' }}"
                                <a
                                href="{{ session('last_search') ? route('huizen.index', ['query' => session('last_search')]) : '#' }}"
