    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex-grow bg-green-100 py-16">
            <div class="container mx-auto">
                <h1 class="text-3xl font-semibold text-gray-700 mb-6">Zoekresultaten voor vakantiehuizen</h1>
                ...
                <div class="lg:flex lg:space-x-6">
                                ...
                                <select name="locatie" id="locatie"
                                    ...
                                    @if (isset($locations) && is_array($locations))
                                        @foreach ($locations as $locatie)
                                            <option value="{{ $locatie['name'] }}"
                                                {{ request('locatie') == $locatie['name'] ? 'selected' : '' }}>
                                                {{ $locatie['name'] }}
                                            </option>
                                        @endforeach
                                    @else
                    ...
                    <div class="w-full lg:w-3/4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6 lg:mt-0">
                            @if (empty($huizen))
                                <p class="text-gray-600">Geen vakantiehuizen gevonden.</p>
                            @else
