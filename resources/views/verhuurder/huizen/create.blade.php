<x-app-layout>
            ...
            @if ($errors->any())
                ...
                <form action="{{ route('verhuurder.huizen.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <<<<<<< HEAD <!-- Naam -->
                        ...
                        <!-- Slaapkamers -->
                        <div class="mb-4">
                            <label for="slaapkamers" class="block text-sm font-medium text-gray-700">Aantal
                                Slaapkamers</label>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex flex-wrap">
                                ...
                                <div x-show="tab === 'general'" class="space-y-4">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div>
                                            <label for="naam"
                                                class="block text-lg font-medium text-gray-700">Naam</label>
                                            <input type="text" id="naam" name="naam"
                                                value="{{ old('naam') }}"
                                        ...
                                        <div>
                                            <label for="prijs"
                                                class="block text-lg font-medium text-gray-700">Prijs (€)</label>
                                            <input type="number" step="0.01" id="prijs" name="prijs"
                                                value="{{ old('prijs') }}"
                                                class="w-full mt-2 p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-green-600 focus:border-green-600"
                                                required autocomplete="off">
                            ...
                            <<<<<<< HEAD <!-- Submit Button -->
                                <button type="submit"
                                    class="bg-green-600 text-white px-4 py-2 rounded-lg">Vakantiehuis
                                    Toevoegen</button>
                </form>
                =======
                <div class="relative">
                    <label for="straatnaam" class="block text-lg font-medium text-gray-700">Straatnaam</label>
                ...
                <div>
                    <label for="huisnummer" class="block text-lg font-medium text-gray-700">Huisnummer</label>
    ...
    <div x-show="tab === 'facilities'" class="space-y-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <label class="flex items-center"><input type="checkbox" name="parkeren" value="1"><span
                    class="ml-2">Parkeerplaats</span></label>
            <label class="flex items-center"><input type="checkbox" name="speeltuin" value="1"><span
